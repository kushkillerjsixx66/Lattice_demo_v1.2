...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-Cwq2akb_.mjs");
...
var manifest = { "450461ff24a84b4b21ef01fa4119d6c562806d88913d83ea86fa38cc68e3d9f5": {
	functionName: "runLivePipeline_createServerFn_handler",
	importer: () => import("./run-pipeline-COXdMU-t.mjs")
} };
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-DiQPVdhY.mjs").then((n) => n.t),
