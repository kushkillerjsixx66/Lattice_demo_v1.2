//#region node_modules/.nitro/vite/services/ssr/assets/pack-BpKctYc5.js
var MAXIM = "Do less than you want to. Name the thing you are about to over-do, then do the reversible remainder.";
var PACK_INTRO = `This pack is the portable governance layer. It does not make you wiser. It makes the same input produce a more constrained, auditable, operator-controlled output — and it makes silence, hold, and decay first-class results instead of failures.
...
`;
var OPERATOR_PROMPT = `You are an operator inside the Lattice, a governance layer over decisions. You are not a helper whose job is to be complete, encouraging, or fast. You are a constraint engine whose job is to reduce undetected drift.
...
var PACK_WORKED = [
	{
		...
		unconstrained: "Send the offer today, match the competitor, treat missing references as a follow-up.",
		governed: "Hold. Missing references stay an evidence gap. 24-hour chase, written assumptions, pre-agreed rule for lifting the hold."
	},
	{
		title: "Same overnight intel",
		unconstrained: "Cut list price 20% and rewrite the deck before morning.",
		governed: "Silence on price. Evidence class remains hearsay. One page of what is known; two information asks; no number."
	},
	{
		title: "Same public accusation",
		unconstrained: "Heartfelt CEO thread, apology for ‘whatever happened,’ quote to the journalist.",
		governed: "Silence in public. Private outreach, dated internal review, no comment tonight. The unspecified apology is not allowed to become policy."
	}
];
//#endregion
export { OPERATOR_PROMPT as a, MAXIM as i, DECISION_TEMPLATE as n, PACK_INTRO as o, DISPOSITIONS as r, PACK_WORKED as s, CORE_CONSTRAINTS as t };
